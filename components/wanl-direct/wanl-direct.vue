<template>
	<view>
		<view class="wanl-direct">
			<view class="menu-header" :style="{paddingTop: $flbooth.wanlsys().top + 'px'}">
				<view>
					功能直达
				</view>
				<view @tap="close">
			...
			<view class="menu-box">
				<view class="menu-item" hover-class="wanl-opcity" @tap="$flbooth.on('/pages/notice/notice')">
				...
				<view class="menu-item" hover-class="wanl-opcity" @tap="$flbooth.on('/pages/index')">
					<view class="badge-box">
						<text class="wlIcon-31shouye"></text>
					</view>
					<view class="menu-text">首页</view>
				</view>
				<view class="menu-item" hover-class="wanl-opcity" @tap="$flbooth.on('/pages/user')">
					<view class="badge-box">
				...
				<view class="menu-item" hover-class="wanl-opcity" @tap="$flbooth.on('/pages/cart')">
					<view class="badge-box">
				...
				<view class="menu-item" hover-class="wanl-opcity" @tap="$flbooth.on('/pages/user/service')">
					<view class="badge-box">
						<text class="wlIcon-unie737"></text>
					</view>
					<view class="menu-text">客服小蜜</view>
				</view>
				<view class="menu-item" hover-class="wanl-opcity" @tap="$flbooth.on('/pages/user/feedback/feedback')">
					<view class="badge-box">
...
<script>
	/**
	 * WanlShare 直达
	 * @description 直达组件 上海蜂雷网络科技有限公司 https://www.flbooth.com（除万联官方内嵌系统，未经授权严禁使用）
