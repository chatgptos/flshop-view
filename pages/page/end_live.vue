	...
	<view>
		<view class="wanl-image">
			<image
				...
				:src="$flbooth.oss(live.image, 0, 50, 1, 'transparent', 'png')"
				mode="aspectFill" 
			></image>
		</view>
		...
		<view class="wanl-end-main" :style="{top: statusBarHeight + 80 + 'px', bottom: statusFootHeight + 50 + 'px'}">
			<view class="wanl-end-main-info text-white">
				...
				<view class="text-center">
					<image class="wanl-end-main-info-image" :src="$flbooth.oss(live.shop.avatar, 100, 100)"></image>
					<view class="text-xl">
						{{live.shop.shopname}}
					</view>
				</view>
			...
			<view class="wanl-end-main-btn" @tap="$flbooth.on('/pages/find')">
