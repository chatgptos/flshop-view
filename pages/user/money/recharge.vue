		...
		methods: {
			...
			paySuccess(){
				...
				this.$store.commit('user/setUserInfo', {
					money: this.$flbooth.bcadd(this.$store.state.user.money, this.money)
				});
				this.$flbooth.to('/pages/page/success?type=recharge');
			}
		}
	}
</script>
