			...
			<view class="bg-white padding-xl margin-bottom-bj" v-for="(item, index) in data" :key="item.id">
				...
				<view class="goods">
					<view class="item solid-bottom" v-for="(goods, indexs) in item.goods" :key="indexs">
						<image :src="$flbooth.oss(goods.image, 125, 125)"></image>
						<view class="info">
							<view>
				...
				<view class="list margin-top-xl text-sm">
					...
					<view class="flex">
						...
						<view class="info"> {{item.created_text}} </view>
					</view>
			...
			<view class="bg-white padding-xl margin-bottom-bj">
				...
				<view class="list margin-top-xl text-sm">
					...
					<view class="flex">
						...
						<view class="info"> {{$flbooth.timeFormat(moneyData.created,'yyyy-mm-dd hh:MM:ss')}} </view>
					</view>
				</view>
			</view>
		</block>
			...
			<view class="bg-white padding-xl margin-bottom-bj">
				...
				<view class="list margin-top-xl text-sm">
					...
					<view class="flex" v-if="data.status == 'successed' && data.transfertime">
						...
						<view class="info"> {{$flbooth.timeFormat(data.transfertime,'yyyy-mm-dd hh:MM:ss')}} </view>
					</view>
		...
		<block v-else-if="moneyData.type == 'refund' && data">
			<view class="bg-white padding-xl margin-bottom-bj">
				<view class="text-center solid-bottom title">
					...
					<view @tap="$flbooth.to(`/pages/user/refund/details?id=${data.refund.id}`)">
				...
				<view class="list margin-top-xl text-sm">
					...
					<view class="flex">
						...
						<view class="info"> {{data.created_text}} </view>
					</view>
					<view class="flex">
						<view class="type wanl-gray"> 支付时间 </view>
					...
					<view class="flex">
						...
						<view class="info"> {{$flbooth.timeFormat(data.refund.created,'yyyy-mm-dd hh:MM:ss')}} </view>
					</view>
					<view class="flex">
						<view class="type wanl-gray"> 退款时间 </view>
						<view class="info"> {{$flbooth.timeFormat(data.refund.completetime,'yyyy-mm-dd hh:MM:ss')}} </view>
					</view>
				</view>
			</view>
		</block>
