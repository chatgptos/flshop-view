<template>
	<view class="wanl-money">
		...
		<view class="cu-list menu sm-border">
			<view class="cu-item arrow" @tap="$flbooth.to('/pages/user/money/recharge')">
				<view class="content">
					<text class="wlIcon-chongzhichenggong text-blue"></text>
					<text>充值</text>
				</view>
			</view>
			<view class="cu-item arrow" @tap="$flbooth.to('/pages/user/money/withdraw')">
				<view class="content">
		...
		<view class="cu-list menu sm-border">
			<view class="cu-item arrow" @tap="$flbooth.to('/pages/user/bank/bank')">
				<view class="content">
			...
			<view class="cu-item arrow" @tap="$flbooth.to('/pages/user/money/list')">
				<view class="content">
					<text class="wlIcon-yue1 text-orange"></text>
					<text>账单明细</text>
				</view>
			</view>
			<view class="cu-item arrow" @tap="$flbooth.to('/pages/user/money/witlist')">
				<view class="content">
