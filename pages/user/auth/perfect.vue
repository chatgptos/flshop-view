	...
	<view>
		<view class="auth">
			...
			<form @submit="formSubmit">
				<view class="avatar">
					<image :src="$flbooth.oss(userInfo.avatarUrl, 50, 50)" mode="aspectFit"></image>
				</view>
		...
		<uni-popup ref="authPopup">
			<view class="wanl-auth-popup bg-white radius-bock text-center">
				<view class="avatar">
					<image :src="$flbooth.appstc('/common/logo.png')" mode="aspectFill"></image>
				</view>
