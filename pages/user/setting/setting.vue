<template>
	<view>
		...
		<view class="cu-list menu sm-border">
			<view class="cu-item" style="min-height:200rpx;" @tap="$flbooth.auth('user')">
				<view class="cu-avatar round lg margin-right"  :style="{backgroundImage: 'url('+ $flbooth.oss(user.avatar, 52, 52, 2, 'avatar') +')'}"></view>
			...
			<view class="cu-item arrow" @tap="$flbooth.auth('../address/address')">
				<view class="content">
					<text>我的收货地址</text>
				</view>
			</view>
		...
		<view class="cu-list menu sm-border margin-top">
			<view class="cu-item arrow" @tap="$flbooth.auth('security')">
				<view class="content">
					<text>账号与安全</text>
				</view>
			</view>
		...
		<view class="cu-list menu sm-border margin-top">
			<view class="cu-item arrow" @tap="$flbooth.to('notice')">
				<view class="content">
					<text>新消息通知</text>
				</view>
			</view>
			<!-- <view class="cu-item arrow" @tap="$flbooth.to('privacy')">
				<view class="content">
					<text>隐私</text>
				</view>
			</view> -->
			<view class="cu-item arrow" @tap="$flbooth.to('currency')">
				<view class="content">
					<text>通用</text>
				</view>
			</view>
		...
		<view class="cu-list menu sm-border margin-top">
			...
			<view class="cu-item arrow" @tap="$flbooth.to('about','pop-in',200)">
				<view class="content">
					<text>关于</text>
				</view>
				<view class="action">
