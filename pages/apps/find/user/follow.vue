			...
			<view class="item padding-bj margin-bj bg-white radius-bock" v-for="(item, index) in dataList"
				...
				<block v-if="item.shop">
					<view class="cu-avatar margin-right-bj round"
						:style="{backgroundImage: `url(${$flbooth.oss(item.shop.avatar, 88, 88)})`}"></view>
					<view class="subject">
						<view class="info">
				...
				<block v-else>
					<view class="cu-avatar margin-right-bj round"
						:style="{backgroundImage: `url(${$flbooth.oss(item.user.avatar, 88, 88)})`}"></view>
					<view class="subject">
						<view class="info">
